  ...
  <Card class="w-full sm:max-w-lg bg-transparent shadow-none border-0">
        ...
        <FieldGroup>
          <VeeField v-slot="{ field, errors }" name="fullName">
            <Field :data-invalid="!!errors.length">
              <FieldLabel for="form-vee-demo-fullName" class="text-white"> Full Name </FieldLabel>
              <Input
                id="form-vee-demo-fullName"
                v-bind="field"
          ...
          <VeeField v-slot="{ field, errors }" name="email">
            <Field :data-invalid="!!errors.length">
              <FieldLabel for="form-vee-demo-email" class="text-white"> Email </FieldLabel>
              <Input
    ...
    <CardFooter class="flex flex-col gap-5 items-center">
      ...
      <p class="text-center text-white">
        ...
        <NuxtLink href="/login" class="text-blue-500 hover:underline">Login</NuxtLink>
      </p>
    </CardFooter>
  </Card>
</template>
